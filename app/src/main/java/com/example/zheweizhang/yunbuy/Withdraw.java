...
public class Withdraw extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (scanningResult != null) {
            ...
            Toast.makeText(Withdraw.this,"掃描成功",Toast.LENGTH_SHORT).show();
            Log.d("HJSON",scanContent);
            parseJSON(scanContent);
        }
        else {
            Toast.makeText(Withdraw.this,"掃描失敗",Toast.LENGTH_SHORT).show();
    ...
    public void next (View view){
        Intent intent = new Intent(this,Withdraw2.class);
