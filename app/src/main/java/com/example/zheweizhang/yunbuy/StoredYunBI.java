...
public class StoredYunBI extends AppCompatActivity {

    String stsuid,stspw,syunbi;
    TextView T_yunbi;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.store_yun_b_i2);
    ...
    public void submit(View view){
        Storeback storeback = new Storeback(this);
        storeback.execute(stsuid, stspw,syunbi);
        Intent intent = new Intent(this,StoreYunBi3.class);
        startActivity(intent);
    }
    class Storeback extends AsyncTask<String,Void,String> {

        public Storeback(StoredYunBI storedYunBI) {
        }

        @Override
        protected String doInBackground(String... params) {
            StringBuilder sb = new StringBuilder();
            String wallet_url = "http://140.125.81.16/YunBuy/StoreYunBI.php";
            try {
